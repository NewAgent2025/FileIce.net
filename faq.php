...
<head><script type="text/javascript" src="_static/js/bundle-playback.js?v=2N_sDSC0" charset="utf-8"></script>
...
<div id="head">
	...
	<div id="promo-container">
        ...
        <div class="right">	
			<h3>
				<ul id="sub-menu">
					<li><a href="about.php?page=overview">Overview</a></li>
					<li><a href="about.php?page=features">Features</a></li>
					<li class="current"><a href="about.php?page=faq">FAQ</a></li>
				</ul>
			</h3>
		</div>
    </div>
				<div align="center"><h2>Coming soon</h2></div>
	<div class="clear"></div>	
		<div id="footer">
		<p>
			<div class="left">
				<h3>Copyright &copy; 2016 FileIce LLC</h3>
			</div>
			<div class="right">
				<h3><a href="#">About</a> | <a href="tos.php">Terms &amp; Conditions</a> | <a href="#head">Go to Top</a></h3>
			</div>
		</p>
	</div>
	</div>
